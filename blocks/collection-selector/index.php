 ...
 * - logo            (image)    -> logo junto al título
...
$logo_url   = nl_cs_img_url($logo, 'medium') ?: nl_cs_img_url($logo, 'full');
...
<section id="<?php echo esc_attr($section_id); ?>" class="<?php echo esc_attr($classes); ?>">
  <div class="cs_section">
    ...
    <div class="cs_header">
      <div class="cs_title-wrap">
        <?php if ($collection_name): ?>
          <h1 class="font-heading-1 cs_title">
            <?php echo esc_html($collection_name); ?>
          </h1>
        <?php elseif ( current_user_can('edit_posts') ): ?>
          <h1 class="font-heading-1 cs_title" style="opacity:.6;">
        ...
        <?php if ($logo_url): ?>
          <img
            class="cs_collection-logo"
            src="<?php echo esc_url($logo_url); ?>"
            alt="<?php echo esc_attr($collection_name ?: 'Logo de colección'); ?>"
            loading="lazy"
            decoding="async">
        <?php elseif ( current_user_can('edit_posts') ): ?>
          <span class="cs_collection-logo-placeholder">
            Asigná “logo”.
          </span>
        <?php endif; ?>
      </div>
